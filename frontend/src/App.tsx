...
const App = () => {
  ...
  useEffect(() => {
    const fetchFavoriteRecipes = async () => {
      try {
        const favoriteRecipes = await api.getFavoriteRecipesByIDs();
  ...
  const removeFavoriteRecipe = async (recipe: Recipe) => {
    try {
        ...
        const updatedRecipes = favoriteRecipes.filter((favRecipe) => favRecipe.id!== recipe.id);
  ...
  return (
    <div className="app-container">
      <div className="header">
        ...
        <div className="title">Recipes By Appliance</div>
      </div>
      <div className="tabs">
        <h1
